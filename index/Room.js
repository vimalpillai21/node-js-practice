...
class Room extends EventEmitter
{
    ...
    {
        console.log("handleProtooConnection call back function hiited");
        const existingPeer = this._protooRoom.getPeer(peerId);
        logger.info('handle Protoo Connection function called');
        if (existingPeer)
        {
            console.log("existingPeer - " + existingPeer);
            logger.warn(
        ...
        logger.info('handle Protoo Connection function called part 2');
        let peer;

        // Create a new protoo Peer with the given peerId.
        try
        {
            logger.info('handle Protoo Connection function called part 3');
        ...
        console.log('handle Protoo Connection function called part 4');
        ...
        console.log('handle Protoo Connection function called part 5');
    ...
    async createBroadcaster({ id, displayName, device = {}, rtpCapabilities })
    {
        ...
        logger.info(`The joined peer list are given below - ${joinedPeers}`);
    ...
    {	// logger.info(`handle Protoo Request - ${request.method}`);
    ...
    {	logger.info('create Consumer function inside ROom JS file');
        // Optimization:
